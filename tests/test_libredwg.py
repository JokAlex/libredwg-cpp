...
def test_example_2000():
    ...
    document.write_dxf("./out_data/example_2000.dxf", pylibredwgcpp.SaveOptions())
...
def test_example_2004():
    ...
    document.write_dxf("./out_data/example_2004.dxf", pylibredwgcpp.SaveOptions())
...
def test_example_2007():
    ...
    document.write_dxf("./out_data/example_2007.dxf", pylibredwgcpp.SaveOptions())
...
def test_example_2010():
    ...
    document.write_dxf("./out_data/example_2010.dxf", pylibredwgcpp.SaveOptions())
...
def test_example_2013():
    ...
    document.write_dxf("./out_data/example_2013.dxf", pylibredwgcpp.SaveOptions())
...
def test_example_2018():
    ...
    document.write_dxf("./out_data/example_2018.dxf", pylibredwgcpp.SaveOptions())
